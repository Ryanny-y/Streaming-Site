...
const MovieCardNoBg = ({ movieId }) => {
  ...
  return (
    <>
      {Object.keys(details)?.length && <div className="flex flex-col gap-3">
        <div id="image_poster">
          <img
        ...
        <h1 id="title" className="text-xl font-semibold tracking-wide">{details.original_title}</h1>

        <div id="rating_duration" className="flex items-center gap-3 text-sm">
          <p>
            <FontAwesomeIcon icon={faStar} className="text-yellow-500" />
            <span className="ml-1">{formatRatings(details.vote_average)}</span>
          </p>
          <p>
